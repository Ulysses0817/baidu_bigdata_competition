...
class MultiModalDataset(Dataset, ):
    ...
    def __getitem__(self,index):
        ...
        if not self.mode == "test":
            return X.float(),(visit.float(),),y#magic.float()
        else:
...
class MultiModalNet(nn.Module):
    def __init__(self, drop):
        ...
        img_model = models.resnet50(True) #se_resnext50_32x4d(pretrained="imagenet")# #pretrainedmodels.__dict__[backbone1](num_classes=1000, pretrained=None)
