...
from utils import *
from multimodal_gai import MultiModalDataset,CosineAnnealingLR,MultiModalNet
...
def test(test_loader,models):
    ...
    with open("../data/stack3_TTA.pkl", 'wb') as f:
            pickle.dump(stack, f)
...
def main():
    ...
    if config.OOF:
        ...
        print(result.shape)
        with open("../data/oof3.pkl", 'wb') as f:
...
#   ==================================================添加初赛数据===================================================
        ## data_old---->train
        all_files_pre = pd.read_csv("../lizeda/dataset/pre_train.csv")
        all_files_pre["Id"] = all_files_pre.Id_y.apply(lambda x: os.path.basename(x)[:-4])
        all_files_pre = all_files_pre.loc[(all_files_pre.black_ratio<0.3)&(all_files_pre.Target!=0), ["Id", "Target"]].copy()
        
        train_index_pre, test_index_pre = [], []
        for fold, (train_index, test_index) in enumerate(skf.split(all_files_pre, all_files_pre.Target)):
...
#   =============================================== ==添加初赛数据====================================================
            ...
            train_data_list = [train_data_list, X_tr_pre]
# ===============================================================================================================
            # max_epoch = 15
            # config.batch_size = 80*3
#   ==================================================================================================================
